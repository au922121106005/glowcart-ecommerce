## 🛒 GlowCart - Django E-Commerce Web Application

GlowCart is a full-stack e-commerce web application built using Django.  
It allows users to browse products, add items to a shopping cart, and manage orders with a simple and responsive UI.
